<?php
class JWT {
    private static $secret = 'super_secret_school_key_2026!'; // In production, use environment variable
    ...
    public static function verifyAuth() {
        ...
        return $decoded; // Returns payload (e.g. user_id, role)
    }

    public static function verifyAdmin() {
        $decoded = self::verifyAuth();
